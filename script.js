...
window.addEventListener("load", function () {
    ...
    listedPlanetsResponse.then(function (result) {
        ...
        let pickedPlanet = scriptHelper.pickPlanet(listedPlanets);
        scriptHelper.addDestinationInfo(document, pickedPlanet.name, pickedPlanet.diameter, pickedPlanet.star, pickedPlanet.distance, pickedPlanet.moons, pickedPlanet.imageUrl);
